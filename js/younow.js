...
async function main(args) {
    ...
    if (!await dos.exists(exports.settings.pathConfig)) {
        await dos.mkdir(exports.settings.pathConfig);
    }
    if (exports.settings.pathMove) {
        if (!await dos.exists(exports.settings.pathMove)) {
            await dos.mkdir(exports.settings.pathMove);
        }
    }
    if (!await dos.exists(exports.settings.pathDownload)) {
        await dos.mkdir(exports.settings.pathDownload);
    }
